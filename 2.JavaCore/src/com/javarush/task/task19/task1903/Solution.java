...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer,Contact {
        ...
        public String getPhoneNumber() {
            String phoneStr = String.format("%010d" ,data.getPhoneNumber());
            return String.format("+%s(%3.3s)%3.3s-%2.2s-%2.2s",data.getCountryPhoneCode(),phoneStr.substring(0,3),phoneStr.substring(3,6),phoneStr.substring(6,8),phoneStr.substring(8,10));
        }
