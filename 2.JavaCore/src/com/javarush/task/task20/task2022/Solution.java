...
public class Solution implements Serializable, AutoCloseable {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException,NoSuchFieldException,IllegalAccessException {
...
//        in.close();
    ...
    public static void main(String[] args) throws ClassNotFoundException,IOException{
        ...
        ObjectOutputStream oos = new ObjectOutputStream(outArray);
        Solution solution = new Solution("C:\\tmp\\task2022.dat");
        solution.writeObject("Something string ");
        oos.writeObject(solution);

        ByteArrayInputStream inArray = new ByteArrayInputStream(outArray.toByteArray());
        ObjectInputStream ois = new ObjectInputStream(inArray);
        Solution newSolution = (Solution) ois.readObject();
        newSolution.writeObject("New string");
