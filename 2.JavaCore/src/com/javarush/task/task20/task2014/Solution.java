...
public class Solution implements Serializable {
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        ObjectOutputStream ou = new ObjectOutputStream(new FileOutputStream("C:\\tmp\\task2014.dat"));
        ou.writeObject(solution);
        ou.close();

        ObjectInputStream oi = new ObjectInputStream(new FileInputStream("C:\\tmp\\task2014.dat"));
