...
public class Solution implements Serializable,Runnable {
    ...
    public void run() {
        ...
        System.out.println(this.toString()+" start work");
        for (int i = 0; i < 1000; i++) {
//            System.out.println("test!!!!");
        }
        System.out.println(this.toString()+" end work");
    }
    ...
    public static void main(String[] args)throws IOException,ClassNotFoundException {
        ...
        ObjectOutputStream ou = new ObjectOutputStream(new FileOutputStream("C:\\tmp\\task2015.dat"));
        ou.writeObject(solution);
        ou.close();

        ObjectInputStream oi = new ObjectInputStream(new FileInputStream("C:\\tmp\\task2015.dat"));
