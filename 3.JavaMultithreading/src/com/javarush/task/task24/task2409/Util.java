...
public class Util {
    ...
    public static List<Jeans> getAllJeans() {
        ...
        abstract class AbstractJeans implements Jeans{
            ...
            public AbstractJeans(int size, int length, int id, double price) {
                this.size = size;
                this.length = length;
                this.id = id;
                this.price = price;
            ...
            public String toString() {
                return String.format("%s{id=%d, length=%d, size=%d, price=%.2f}",getClass().getSimpleName(),id,length,size,price);
            }
